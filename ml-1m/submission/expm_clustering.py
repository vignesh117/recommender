...
sample_users = [random.choice(points) for i in range(1,21)]
#print sample_users


# This function plays a run with 500 rounds
def play(p,round):
...
# This function does the final recommendation
def recommend(p):
